...
public class Instructions extends CustomScreen {
	...
	public Instructions() {
    	...
    	setName("INSTRUCTIONS");		//Sets the current activity name	
        ...
        Label adminHeader = new Label("Administrator", header2Skin);
        adminHeader.setAlignment(Align.center);
        
        Label playerHeader = new Label("Player", header2Skin);
    	...
    	back.addListener(new ChangeListener() {
    		public void changed (ChangeEvent event, Actor actor) {
    			ScreenManager.getInstance().show("MAIN_MENU", Screens.MAIN_MENU);	//switch to "Administrator Home" activity
    		}
    	});
        ...
        scrollTable.add(adminHeader).spaceBottom(Gdx.graphics.getWidth()/60);
        scrollTable.row();
        ...
        scrollTable.add(playerHeader).spaceBottom(Gdx.graphics.getWidth()/60);
        scrollTable.row();
